...
<div class="container-fluid" style="background:#f5f5f5; padding-bottom:50px;">
    <div class="paper-wrapper">
        <div class="paper-form">
            <h2 class="paper-title"><i class="mdi mdi-briefcase-edit-outline me-2 text-warning"></i>Edit Program Kewirausahaan &amp; Inkubasi Bisnis</h2>
...
<script>
(function initEditProgram() {
    if (typeof flatpickr === 'undefined') {
        return setTimeout(initEditProgram, 50);
    }
